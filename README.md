...
*Version 2.5.0* - For the latest version, check out the [dev](https://github.com/ftsrg/gamma/tree/dev) branch.
...
* Install VIATRA 2.5.0 and the Yakindu Statechart Tools 3.5.13.
...
* [Versenyképességi és kiválósági együttműködések program (VKE)](www.prolan.hu/hu/oldal/VKE) (2018-1.3.1-VKE-2018-00040 projekt).
