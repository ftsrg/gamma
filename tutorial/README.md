...
=======
- Download a new Eclipse IDE for [Java and DSL Developers package](https://www.eclipse.org/downloads/packages/release/2019-09/r/eclipse-ide-java-and-dsl-developers).
>>>>>>> dev
- Install the following two packages. The _Install_ window can be opened via the _Help > Install New Software..._ menu item. In the _Install_ window click _Add..._, and paste the necessary URL in the _Location_ text field. 
  - Install VIATRA 2.2.1 from update site http://download.eclipse.org/viatra/updates/release/2.2.1.
    - Choose the whole _VIATRA Query and Transformation SDK_ package.
 - Install the Yakindu Statechart Tools 3.5.8. from update site http://updates.yakindu.com/statecharts/releases/.
...
Download the [Gamma tutorial](https://inf.mit.bme.hu/sites/default/files/gamma/2_2_1/gamma-tutorial-pack-2.2.1.zip), and extract its contents.
