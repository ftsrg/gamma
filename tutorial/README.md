...
- Install the following two packages. The _Install_ window can be opened via the _Help > Install New Software..._ menu item. In the _Install_ window click _Add..._, and paste the necessary URL in the _Location_ text field. 
 ...
 - Intall the Yakindu Statechart Tools 3.4.3. from update site: http://updates.yakindu.com/statecharts/releases/.
...
![VIATRA components](tutorial/images/viatra-update-site.png "VIATRA components")

![Yakindu components](tutorial/images/yakindu-update-site.png "Yakindu components")
...
![Workspace settings](tutorial/images/workspace-settings.png "Workspace settings")
...
Download the [Gamma tutorial](http://inf.mit.bme.hu/sites/default/files/gamma/2_0_2/gamma-tutorial-2.0.2.zip), and extract its contents.
...
![Crossroad states](tutorial/images/crossroad-states.png "Crossroad states")
...
![Start project](tutorial/images/start-project.png "Start project")
...
![Crossroad component](tutorial/images/crossroad-component.png "Crossroad component")
...
![Menu: compile interface](tutorial/images/menu-compile-interface.png "Menu: compile interface")
...
![Menu: generate Java code](tutorial/images/java-code-generation.png "Menu: generate Java code")
...
![Query generator GUI](tutorial/images/query-generator-gui.png "Query generator GUI")
