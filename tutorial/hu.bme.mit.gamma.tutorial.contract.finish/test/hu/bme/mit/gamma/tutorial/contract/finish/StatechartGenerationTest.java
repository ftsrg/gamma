...
public class StatechartGenerationTest {
	...
	public void delayWithReceivesTest(){
		try {
			assertTrue(comparator.compare(input+"DelayWithReceivesStatechart.gcd", reference+"DelayWithReceivesStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void InitialOutputsTest(){
		try {
			assertTrue(comparator.compare(input+"InitialOutputsStatechart.gcd", reference+"InitialOutputsStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void negBlockTest(){
		try {
			assertTrue(comparator.compare(input+"NegBlockSendsPermissiveStatechart.gcd", reference+"NegBlockSendsPermissiveStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void negSignalTest(){
		try {
			assertTrue(comparator.compare(input+"NegSendsStrictStatechart.gcd", reference+"NegSendsStrictStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void receivesPermissiveTest(){
		try {
			assertTrue(comparator.compare(input+"ReceivesPermissiveStatechart.gcd", reference+"ReceivesPermissiveStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void sendsPermissiveTest(){
		try {
			assertTrue(comparator.compare(input+"SendsPermissiveStatechart.gcd", reference+"SendsPermissiveStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void receivesStrictTest(){
		try {
			assertTrue(comparator.compare(input+"ReceivesStrictStatechart.gcd", reference+"ReceivesStrictStatechart.gcd"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
