...
*/
E<> sendingInteractionOfcontroller == 4 && receivingInteractionOfprior == 9 && isStable
/*
controller: Priority -i-> second: Yellow-->Red
*/
E<> sendingInteractionOfcontroller == 1 && receivingInteractionOfsecond == 7 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 5 && receivingInteractionOfprior == 2 && isStable
/*
