...
*/
E<> sendingInteractionOfcrossroad_controller == 2 && receivingInteractionOfcrossroad_prior == 6 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 4 && receivingInteractionOfcrossroad_second == 2 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 4 && receivingInteractionOfcrossroad_second == 1 && isStable
/*
crossroad_controller: Operating-->Operating -i-> crossroad_prior: Normal-->Interrupted
*/
E<> sendingInteractionOfcrossroad_controller == 3 && receivingInteractionOfcrossroad_prior == 4 && isStable
/*
crossroad_controller: Operating-->Operating -i-> crossroad_prior: Interrupted-->Normal
*/
E<> sendingInteractionOfcrossroad_controller == 3 && receivingInteractionOfcrossroad_prior == 9 && isStable
/*
crossroad_controller: Priority -i-> crossroad_second: Red-->Green
*/
E<> sendingInteractionOfcrossroad_controller == 2 && receivingInteractionOfcrossroad_second == 2 && isStable
/*
crossroad_controller: Priority -i-> crossroad_second: Yellow-->Red
*/
E<> sendingInteractionOfcrossroad_controller == 2 && receivingInteractionOfcrossroad_second == 5 && isStable
/*
crossroad_controller: Priority -i-> crossroad_second: Green-->Yellow
*/
E<> sendingInteractionOfcrossroad_controller == 2 && receivingInteractionOfcrossroad_second == 1 && isStable
/*
crossroad_controller: Operating-->Operating -i-> crossroad_second: Normal-->Interrupted
*/
E<> sendingInteractionOfcrossroad_controller == 3 && receivingInteractionOfcrossroad_second == 7 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 5 && receivingInteractionOfcrossroad_prior == 8 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 1 && receivingInteractionOfcrossroad_second == 2 && isStable
/*
crossroad_controller: Secondary -i-> crossroad_second: Yellow-->Red
*/
E<> sendingInteractionOfcrossroad_controller == 1 && receivingInteractionOfcrossroad_second == 5 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_prior == 4 && receivingInteractionOfmonitor == 4 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_prior == 0 && receivingInteractionOfmonitor == 5 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_prior == 3 && receivingInteractionOfmonitor == 3 && isStable
/*
