...
*/
E<> sendingInteractionOfcrossroad_controller == 4 && receivingInteractionOfcrossroad_prior == 8 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 0 && receivingInteractionOfcrossroad_prior == 1 && isStable
/*
crossroad_controller: Secondary -i-> crossroad_prior: Red-->Green
*/
E<> sendingInteractionOfcrossroad_controller == 0 && receivingInteractionOfcrossroad_prior == 7 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 3 && receivingInteractionOfcrossroad_prior == 5 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 1 && receivingInteractionOfcrossroad_second == 3 && isStable
/*
crossroad_controller: Priority -i-> crossroad_second: Yellow-->Red
*/
E<> sendingInteractionOfcrossroad_controller == 1 && receivingInteractionOfcrossroad_second == 0 && isStable
/*
...
*/
E<> sendingInteractionOfcrossroad_controller == 5 && receivingInteractionOfcrossroad_second == 0 && isStable
