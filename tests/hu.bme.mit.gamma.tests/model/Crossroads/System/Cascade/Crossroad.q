...
*/
E<> sendingInteractionOfcontroller == 1 && receivingInteractionOfprior == 8 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 1 && receivingInteractionOfsecond == 2 && isStable
/*
controller: Priority -i-> prior: Green-->Yellow
*/
E<> sendingInteractionOfcontroller == 0 && receivingInteractionOfprior == 6 && isStable
/*
controller: Priority -i-> prior: Yellow-->Red
*/
E<> sendingInteractionOfcontroller == 0 && receivingInteractionOfprior == 5 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 0 && receivingInteractionOfsecond == 7 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 4 && receivingInteractionOfsecond == 7 && isStable
/*
controller: Secondary -i-> second: Red-->Green
*/
E<> sendingInteractionOfcontroller == 4 && receivingInteractionOfsecond == 0 && isStable
/*
controller: PriorityPrepares -i-> prior: Green-->Yellow
*/
E<> sendingInteractionOfcontroller == 3 && receivingInteractionOfprior == 6 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 4 && receivingInteractionOfprior == 5 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 5 && receivingInteractionOfsecond == 3 && isStable
/*
...
*/
E<> sendingInteractionOfcontroller == 5 && receivingInteractionOfsecond == 0 && isStable
