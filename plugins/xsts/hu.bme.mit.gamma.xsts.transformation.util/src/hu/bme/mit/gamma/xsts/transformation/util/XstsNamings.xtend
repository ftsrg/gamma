...
class XstsNamings {
	...
	static def String getFlowVariableName(ControlFlow flow) '''activity_flow_from_«flow.sourceNode.name»_to_«flow.targetNode.name»_state'''
	static def String getFlowVariableName(DataFlow flow) '''activity_flow_from__to__state'''
