...
public class PropertyModelDerivedFeatures extends StatechartModelDerivedFeatures {
	...
	public static String serialize(UnaryPathOperator operator) {
		switch (operator) {
	...
	public static String serialize(BinaryPathOperator operator) {
		switch (operator) {
	...
	public static boolean getBooleanResultIfTraceExists(StateFormula formula) {
		return isEQuantified(formula);
	}
