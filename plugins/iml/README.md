...
2. Set up [Imandra](https://imandra.ai/). For this, you will need Python 3:
	...
	- Add the folder containing the *imandra-cli* executable to your systems's `PATH` environment or default search path (depending on your OS) - this is needed for the manual stopping (killing) of Imandra instances in the cloud environment.
